...
exports.findEmployeeLocationById = function(req,res){
	...
	var query = {$or:[{"_id":employeeLocationObjId},{"EmployeeId":req.params.Id},{"PrimaryPhone":req.params.Id},{"SecondaryPhone":req.params.Id},{'ContactAddress.Pincode':req.params.Id},{'ContactAddress.City':req.params.Id},{'ContactAddress.Zone':req.params.Id},{'ContactAddress.State':req.params.Id},{'ContactAddress.Area':req.params.Id}]};	
	...
	if(location)
	{
		...
		var limit =  100;
		var coordinates = [];
	    coordinates[0] = location.geo.coordinates[0];//req.query.longitude;
	    coordinates[1] = location.geo.coordinates[1];//req.query.latitude;
...
exports.updateEmployeeLocationById = function(req,res){
	...
	employeeLocationModel.findOneAndUpdate(query,{$add:updateData},options,function(err,feedback){
		if (err) res.send(err);;
		if(feedback)
		{
			res.json(feedback);
